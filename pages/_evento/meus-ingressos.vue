          ...
          <b-row>
            ...
            <b-col class="pl-md-0 mt-3 mt-md-0">
              <div class="px-3">
                ...
                <b-button
                  @click="buscaIngressos()"
                  class="btn-padrao text-dark mt-2 px-4 mb-2"
                >
                  Atualizar Ingressos
                </b-button>
              ...
              <div v-if="carrega" class="text-center mt-3 mb-2">
                <div class="border py-3">
                  ...
                  <img
                    class="mt-3"
                    src="../../assets/icones/ingressoicone.png"
                    alt=""
                  />
                </div>
              </div>
              <div
                v-if="ingressos.length === 0 && !carrega"
                class="text-center mb-3 mb-2"
              >
                <div class="border py-3">
                  ...
                  <div>
                    <b-row>
                      ...
                      <b-col
                        ...
                        cols="8"
                        md="6"
                        class="text-right align-self-centeri"
                      >
                        <b-button variant="success" class="px-3"
                          >Reenviar Ingressos</b-button
                        >
                      </b-col>
                    </b-row>
                    <div class="card-ingresso mt-2">
                      <b-row>
                        ...
                        <b-col md="1" v-else>
                          <b-button
                            block
                            :href="`https://arquivos.devnx.com.br/goingressos/uploads/${ing.img}`"
                            target="_blank"
                            v-if="ing.img"
                            class="
                              bg-ico
                    ...
                    <div class="d-flex justify-content-between">
                      <p class="small mt-2">
                        CPF: {{ ing.documento | VMask("###.###.###.##") }}
                      </p>
                      <p class="small mt-2">
                        Última alteração:
                        {{ ing.updated_at | moment("DD/MM - H:mm") }}
                      </p>
                    </div>
                  </div>
                </div>
